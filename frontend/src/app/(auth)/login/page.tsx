  ...
  const handleSubmit = async (e: React.SyntheticEvent) => {
    ...
    try {
      ...
      setError(
        ...
        "Gagal melakukan login. Silakan periksa kembali email dan password Anda."
      );
    } finally {
      setIsLoading(false);
    }
      ...
      <div className={AppContainers.authCardWidth}>
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Masukkan email dan kata sandi untuk mengakses kontrol panel</CardDescription>
          </CardHeader>
